...
<body>
  ...
  <div class="container">
    ...
    <table class="table table-condensed">
      ...
      <tbody>
        <?php $i = 0;
        foreach (vhost_list() as $key => $value) : $i++; ?>
          <tr>
    ...
    <table class="table table-condensed">
      ...
      <tbody>
        <?php $i = 0;
        foreach (mysql_list() as $key => $value) : $i++; ?>
          <tr>
            <th scope="row"><?php echo $i ?></th>
    ...
    <table class="table table-condensed">
      ...
      <tbody>
        <?php $i = 0;
        foreach (ftp_list() as $key => $value) : $i++; ?>
          <tr>
            <th scope="row"><?php echo $i ?></th>
...
function mysql_list()
{
  ...
  $result = mysqli_query($con, 'SELECT User, Host FROM mysql.user');
  $data = array();
